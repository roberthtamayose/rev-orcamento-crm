...
def read_vendedor(skip: Optional[int] = None, limit: Optional[int] = None, filter: Optional[str]= "idVendedor", idVendedor: Optional[int] = None, db: Session = Depends(get_db)):
    if idVendedor:
